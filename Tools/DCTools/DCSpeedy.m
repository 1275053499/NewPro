...
+ (CGSize)dc_calculateTextSizeWithText : (NSString *)text WithTextFont: (NSInteger)textFont WithMaxH : (CGFloat)maxH {
...
+ (void)dc_setUpLabel:(UILabel *)label Content:(NSString *)content IndentationFortheFirstLineWith:(CGFloat)emptylen
{
    ...
    NSAttributedString *attrText = [[NSAttributedString alloc] initWithString:content.length? content:@"" attributes:@{NSParagraphStyleAttributeName:paraStyle01}];
